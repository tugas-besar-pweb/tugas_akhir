                 ...
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                      <a class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>jabatan/editjabatan/<?php echo $row['id_jab']; ?>"><i class="fa fa-pencil"></i></a>
                      <a onclick="return confirm('Hapus data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>jabatan/hapusjab/<?php echo $row['id_jab']; ?>"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
